...
sub FIRST_16_ROUNDS_AND_SCHED_1()
{
...
sub FIRST_16_ROUNDS_AND_SCHED_2()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
    ror $t0,$A,#20                         // A <<< 12
...
sub FIRST_16_ROUNDS_AND_SCHED_3()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
    ror $t0,$A,#20                         // A <<< 12
...
sub FIRST_16_ROUNDS_AND_SCHED_4()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
     mov $W,$X0.s[3]                       // W[-13]
...
sub SECOND_36_ROUNDS_AND_SCHED_1()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
     eor $XFER.16b,$X0.16b,$X1.16b         // WW
...
sub SECOND_36_ROUNDS_AND_SCHED_2()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
    ror $t0,$A,#20                         // A <<< 12
...
sub SECOND_36_ROUNDS_AND_SCHED_3()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
    ror $t0,$A,#20                         // A <<< 12
...
sub SECOND_36_ROUNDS_AND_SCHED_4()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
     mov $W,$X0.s[3]                       // W[-13]
...
sub THIRD_12_ROUNDS_WITHOUT_SCHED_1()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
     eor $XFER.16b,$X0.16b,$X1.16b         // WW
...
sub THIRD_12_ROUNDS_WITHOUT_SCHED_2()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
    ror $t0,$A,#20                         // A <<< 12
...
sub THIRD_12_ROUNDS_WITHOUT_SCHED_3()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
    ror $t0,$A,#20                         // A <<< 12
...
sub THIRD_12_ROUNDS_WITHOUT_SCHED_4()
{
    my ($X0,$X1,$X2,$X3,$A,$B,$C,$D,$E,$F,$G,$H) = @_;
$code.=<<___;
    ror $t0,$A,#20                         // A <<< 12
...
$code.=<<___;
# void sm3_compress_neon(u32 digest[8], const u8 *block, u64 nb);
.globl	sm3_compress_neon
.type	sm3_compress_neon,%function
.align	5
sm3_compress_neon:
...
# first 16 rounds
for($i=0;$i<4;$i++) {
    &FIRST_16_ROUNDS_AND_SCHED_1(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &FIRST_16_ROUNDS_AND_SCHED_2(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &FIRST_16_ROUNDS_AND_SCHED_3(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &FIRST_16_ROUNDS_AND_SCHED_4(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
...
# second 36 rounds
for($i=0;$i<9;$i++) {
    &SECOND_36_ROUNDS_AND_SCHED_1(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &SECOND_36_ROUNDS_AND_SCHED_2(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &SECOND_36_ROUNDS_AND_SCHED_3(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &SECOND_36_ROUNDS_AND_SCHED_4(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
...
# third 12 rounds
for($i=0;$i<3;$i++) {
    &THIRD_12_ROUNDS_WITHOUT_SCHED_1(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &THIRD_12_ROUNDS_WITHOUT_SCHED_2(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &THIRD_12_ROUNDS_WITHOUT_SCHED_3(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
    &THIRD_12_ROUNDS_WITHOUT_SCHED_4(@M,@V1,@V2);
    unshift(@V1,pop(@V1));
    unshift(@V2,pop(@V2));
...
.done_hash:
    ...
    ret
.size	sm3_compress_neon,.-sm3_compress_neon
___
